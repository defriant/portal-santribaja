...
const Home = () => {
    ...
    function renderSection(data: any, index: number) {
        switch(data?.type) {
            ...
            case 'gallery':
                return <Gallery key={index} data={data?.data} />
            case 'album':
                return <Album key={index} data={data?.data} />
            case 'article':
                return <Article key={index} data={data?.data} />
            case 'category':
                return <Category key={index} data={data?.data} />
        }
    }
